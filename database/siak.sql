...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Sep 2019 pada 14.28
...
--
-- Indeks untuk tabel `unit_kompetensi`
--
...
--
-- AUTO_INCREMENT untuk tabel `unit_kompetensi`
--
ALTER TABLE `unit_kompetensi`
...
--
-- Ketidakleluasaan untuk tabel `detail_group`
--
ALTER TABLE `detail_group`
